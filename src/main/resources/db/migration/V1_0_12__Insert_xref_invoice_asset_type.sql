...
-- -----------  ------------   ----------                 ------------      -------------------------------------------------------------------------------------------
-- 1100         25-Jun-2020    LAFS                       Wayne S.          Initial
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
  v_count   NUMBER := 0;
BEGIN
  SELECT count(1)
  ...
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('INVOICE-ASSET-TYPE', 'GRD_INTRNL', ' ');
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('INVOICE-ASSET-TYPE', 'PUR_INVADJ', ' ');
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('INVOICE-ASSET-TYPE', 'PUR_COSTPL', ' ');
