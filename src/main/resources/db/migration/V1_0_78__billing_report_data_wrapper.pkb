...
----------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  -- 02-JUN-2022    LAFS-9839                  Wayne S.          Initial
  ----------------------------------------------------------------------------------------------------------------------------------------------------------
  PROCEDURE merge_willow_data(pi_account_code IN VARCHAR2, pi_accounting_period IN VARCHAR2) IS
  BEGIN
    --billing_report_data.merge_willow_data(pi_account_code, pi_accounting_period);
    null;
  EXCEPTION 
    WHEN OTHERS THEN
