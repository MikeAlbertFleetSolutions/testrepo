...
-- -----------  ------------   ----------                 ------------      -------------------------------------------------------------------------------------------
-- 1100         07-May-2020    LAFS                       Wayne S.          Part 2 for the day: Changes were made to the items mapping doc, updating to reflect changes.
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
  v_count   NUMBER := 0;
BEGIN
  SELECT count(1)
  ...
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('PO-ITEM', 'FLMAINT,0', 'Maintenance - Non Rebillable');
  ...
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('PO-ITEM', 'FLMAINT,3', 'Maintenance - Rebillable');    
   
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('PO-ITEM', 'FLMAINTNA,0', 'Maintenance - Rebillable'); 
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('PO-ITEM', 'FLMAINTNA,1', 'Maintenance - Company Vehicle'); 
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('PO-ITEM', 'FLMAINTNA,2', 'Maintenance - Rental'); 
