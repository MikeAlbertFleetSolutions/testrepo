...
--
-- Purpose  : Changes to CLIENT_CATEGORY xref entries
--
-- Modification history
--
-- Version      Version Date   Log Number                 Changed By        Description/Reason for change
-- -----------  ------------   ----------                 ------------      -------------------------------------------------------------------------------------------
-- 1100         21-Apr-2021    LAFS-2533                  Wayne S.          Initial
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
  v_count   NUMBER := 0;
BEGIN
  SELECT count(1)
  ...
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('CLIENT-CATEGORY', 'CONS-LEASE', 'Consumer Lease');
  ...
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('CLIENT-CATEGORY', 'INS-BROKER', 'Insurance Broker');
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('CLIENT-CATEGORY', 'INSURANCE', 'Insurance');
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('CLIENT-CATEGORY', 'MAINT REB', 'Maintenance Rebate');  
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('CLIENT-CATEGORY', 'MA_LC', 'Purchase Product');
  INSERT INTO xref(group_name, internal_value, external_value) VALUES('CLIENT-CATEGORY', 'MEDTRONIC', 'Medtronic - Consumers');
