...
@Component
public class VendorBillPaymentNotificationRoute extends BaseRoute {	
	...
	public void configure() throws Exception {		  		
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.VENDOR_BILL_PAYMENT_NOTIFY.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=1", qPrefix, QueueEnum.VENDOR_BILL_PAYMENT_NOTIFY.getName()))
		  .to("bean:vendorBillPaymentNotificationProcessor");
	}
