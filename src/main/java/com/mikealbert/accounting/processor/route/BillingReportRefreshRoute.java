...
@Component
public class BillingReportRefreshRoute extends BaseRoute {	
	...
	public void configure() throws Exception {		  		
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.BILLING_REPORT_REFRESH.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=5", qPrefix, QueueEnum.BILLING_REPORT_REFRESH.getName()))
		  .to("bean:billingReportRefreshQueueProcessor");
	}
