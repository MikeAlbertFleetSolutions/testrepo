...
@Component
public class LeaseInterestUpdateRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.LEASE_INTEREST_UPDATE.getName(), "DEAD"))
				.useOriginalMessage()
		...
		from(String.format("jms:%s.%s?concurrentConsumers=3", qPrefix, QueueEnum.LEASE_INTEREST_UPDATE.getName()))
		.to("bean:leaseInterestUpdateProcessor");
	}
}
