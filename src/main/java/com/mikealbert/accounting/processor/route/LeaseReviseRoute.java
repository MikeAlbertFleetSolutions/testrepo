...
@Component
public class LeaseReviseRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.LEASE_REVISE.getName(), "DEAD"))
				.useOriginalMessage()
		...
		from(String.format("jms:%s.%s", qPrefix, QueueEnum.LEASE_REVISE.getName()))
		.to("bean:leaseReviseReadProcessor")
		.to("bean:leaseReviseProcessor");
	}
}
