...
@Component
public class DriverUnitHistoryRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.DRIVER_UNIT_HISTORY.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=4", qPrefix, QueueEnum.DRIVER_UNIT_HISTORY.getName()))
		.to("bean:driverUnitHistoryUpsertReadProcessor")
		.to("bean:driverUnitHistoryProcessor");
	}
