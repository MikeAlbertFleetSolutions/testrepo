...
@Component
public class PurchaseOrderCloseInboundRoute extends BaseRoute {	
	...
	public void configure() throws Exception {		  		
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.PO_CLOSE_INBOUND.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=5", qPrefix, QueueEnum.PO_CLOSE_INBOUND.getName()))
		  .to("bean:purchaseOrderCloseInboundQueueProcessor");
	}
