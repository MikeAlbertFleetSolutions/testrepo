...
@Component
public class XRefPutRoute extends BaseRoute {		
	...
	public void configure() throws Exception {	
		...
		from(String.format("jms:%s.%s?selector=action='%s'", qPrefix, QueueEnum.XREF.getName(), XRefQueueSelectorEnum.PUT_XREF.getName()))
		.to("bean:xRefPutProcessor");		
	}
