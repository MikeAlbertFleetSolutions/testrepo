...
@Component
public class AssetIntegrationWillowToNsRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		onException(
				...
				InvalidCredentialsFault.class, AxisFault.class ) 
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.ASSET_WILLOW_TO_NS.getName(), "DEAD"))
				.useOriginalMessage()
		...
		from(String.format("jms:%s.%s?concurrentConsumers=1", qPrefix, QueueEnum.ASSET_WILLOW_TO_NS.getName()))
		.to("bean:assetIntegrationWillowToNsProcessor")
		.to("bean:assetSuiteTalkWillowToNsProcessor");
	}
