...
@Component
public class UnitRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.UNIT_UPSERT.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s", qPrefix, QueueEnum.UNIT_UPSERT.getName()))		
		.to("bean:unitInternalReadProcessor")
		.to("bean:unitProcessor");
	}
