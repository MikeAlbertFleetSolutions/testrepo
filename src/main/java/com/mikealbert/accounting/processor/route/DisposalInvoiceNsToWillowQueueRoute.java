...
@Component
public class DisposalInvoiceNsToWillowQueueRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.INVOICE_DISPOSAL_NS_TO_WILLOW.getName(), "DEAD"))
				.useOriginalMessage()
		...
		from(String.format("jms:%s.%s?concurrentConsumers=1", qPrefix, QueueEnum.INVOICE_DISPOSAL_NS_TO_WILLOW.getName()))		
		.to("bean:disposalInvoiceNsToWillowQueueProcessor");
	}
