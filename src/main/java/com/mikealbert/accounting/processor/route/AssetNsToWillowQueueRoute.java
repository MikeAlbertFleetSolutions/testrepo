...
@Component
public class AssetNsToWillowQueueRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		onException(
				...
				InvalidCredentialsFault.class, AxisFault.class, NoDataFoundException.class, RetryableSuiteTalkException.class) 
		.useOriginalMessage()
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.ASSET_NS_TO_WILLOW.getName(), "DEAD"))
				.useOriginalMessage()
		...
		from(String.format("jms:%s.%s?concurrentConsumers=2", qPrefix, QueueEnum.ASSET_NS_TO_WILLOW.getName()))		
		.to("bean:assetNsToWillowQueueProcessor");
	}
