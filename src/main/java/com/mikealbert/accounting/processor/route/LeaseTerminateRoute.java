...
@Component
public class LeaseTerminateRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.LEASE_TERMINATE.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s", qPrefix, QueueEnum.LEASE_TERMINATE.getName()))
		.to("bean:leaseTerminateProcessor");		
	}
}
