...
@Component
public class VendorRoute extends BaseRoute {	
	...
	public void configure() throws Exception {		  		
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.VENDOR_UPDATE.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=3", qPrefix, QueueEnum.VENDOR_UPDATE.getName()))
		  .to("bean:vendorQueueProcessor");
	}
