...
@Component
public class ClientTransactionGroupRoute extends BaseRoute {	
	...
	public void configure() throws Exception {		  		
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.CLIENT_TRANSACTION_GROUP_UPDATE.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=2", qPrefix, QueueEnum.CLIENT_TRANSACTION_GROUP_UPDATE.getName()))
		  .to("bean:clientTransactionGroupQueueProcessor");
	}
