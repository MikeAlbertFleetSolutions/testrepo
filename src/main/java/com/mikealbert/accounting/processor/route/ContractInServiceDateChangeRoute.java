...
@Component
public class ContractInServiceDateChangeRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.CONTRACT_IN_SERVICE_DATE_CHANGE.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s", qPrefix, QueueEnum.CONTRACT_IN_SERVICE_DATE_CHANGE.getName()))
		.to("bean:contractInServiceDateChangeProcessor");
	}
}
