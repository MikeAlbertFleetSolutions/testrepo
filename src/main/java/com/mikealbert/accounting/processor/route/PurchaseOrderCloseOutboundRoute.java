...
@Component
public class PurchaseOrderCloseOutboundRoute extends BaseRoute {	
	...
	public void configure() throws Exception {		  		
		...
		onException(
				...
				InvalidCredentialsFault.class, AxisFault.class, RetryableSuiteTalkException.class, SuiteTalkNoRecordFoundException.class) 
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.PO_CLOSE_OUTBOUND.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=1", qPrefix, QueueEnum.PO_CLOSE_OUTBOUND.getName()))
		  .to("bean:purchaseOrderCloseOutboundProcessor");
	}
