...
@Component
public class LeaseActualEndDateUpdateRoute extends BaseRoute {		
	...
	public void configure() throws Exception {
		...
		onException(
				...
				InvalidCredentialsFault.class, AxisFault.class, RetryableSuiteTalkException.class, RetryableException.class)
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.LEASE_ACTUAL_END_DATE_UPDATE.getName(), "DEAD"))
				.useOriginalMessage()
		...
		from(String.format("jms:%s.%s", qPrefix, QueueEnum.LEASE_ACTUAL_END_DATE_UPDATE.getName()))
		.to("bean:leaseActualEndDateUpdateProcessor");
	}
}
