...
@Component
public class ClientTransactionGroupCompleteRoute extends BaseRoute {
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.CLIENT_TRANSACTION_GROUP_COMPLETE.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s?concurrentConsumers=2", qPrefix, QueueEnum.CLIENT_TRANSACTION_GROUP_COMPLETE.getName()))
		  .to("bean:clientTransactionGroupCompleteQueueProcessor");
	}    
}
