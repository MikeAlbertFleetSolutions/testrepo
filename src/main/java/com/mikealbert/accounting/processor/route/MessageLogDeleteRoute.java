...
@Component
public class MessageLogDeleteRoute extends BaseRoute{
	...
	public void configure() throws Exception {
		...
		errorHandler(deadLetterChannel(String.format("jms:%s.%s.%s", qPrefix, QueueEnum.MESSAGE_LOG_DELETE.getName(), "DEAD"))
				.useOriginalMessage()				
		...
		from(String.format("jms:%s.%s", qPrefix, QueueEnum.MESSAGE_LOG_DELETE.getName()))
		.to("bean:messageLogDeleteProcessor");
	}
